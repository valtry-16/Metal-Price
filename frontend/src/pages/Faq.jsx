      ...
      <div className="al-faq__shell">
        ...
        <section className="al-faq__features-section">
          ...
          <div className="al-faq__features-grid">
            {[
              { icon: "\u{1F4CA}", title: "Real-Time Pricing", desc: "Live precious metal prices updated hourly from MCX feeds with INR conversion" },
              { icon: "\u{1F916}", title: "AI Market Summary", desc: "Daily AI-generated analysis of market trends, movements, and investment insights" },
              { icon: "\u{1F4AC}", title: "AI Chatbot", desc: "Ask questions about prices, trends, comparisons, and get instant intelligent responses" },
              { icon: "\u{1F514}", title: "Smart Alerts", desc: "Price threshold and percentage change alerts via browser push and email notifications" },
              { icon: "\u{1F4BC}", title: "Portfolio Simulator", desc: "Virtual trading balance to practice metal investments with real live prices" },
              { icon: "\u{1F48E}", title: "Jewellery Calculator", desc: "Calculate jewellery prices with purity, making charges, GST, and historical dates" },
              { icon: "\u{1F4C8}", title: "Metal Comparison", desc: "Side-by-side analysis with correlation, volatility, SMA, and trend charts" },
              { icon: "\u{1F4C4}", title: "PDF & CSV Export", desc: "Download professional market reports with charts, stats, and share functionality" },
              { icon: "\u2709\uFE0F", title: "Daily Emails", desc: "Automated daily price emails with detailed market summary and trends" },
              { icon: "\u{1F4F1}", title: "PWA Support", desc: "Install as a native app on mobile or desktop with offline support" },
              { icon: "\u{1F319}", title: "Dark / Light Mode", desc: "Elegant luxury theme with smooth dark/light mode toggle for comfort" },
              { icon: "\u{1F916}", title: "Telegram Bot", desc: "Get instant metal prices and alerts directly in your Telegram app" },
            ].map((f) => (
